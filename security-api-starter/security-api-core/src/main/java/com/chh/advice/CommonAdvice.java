...
abstract class CommonAdvice {
    ...
    protected boolean showLog(SecurityParameter securityAnnotation, SecurityEncryptConfig secretEncryptConfig) {
        return securityAnnotation.showLog() && secretEncryptConfig.isShowLog();
    }

    protected boolean cacheData(SecurityParameter securityAnnotation, SecurityEncryptConfig secretEncryptConfig) {
